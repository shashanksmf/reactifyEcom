          ...
          <div className="content">
            <div className="logo">
              <table height={56} cellPadding={0} cellSpacing={0}>
                <tbody><tr>
                  <td valign="middle">
                    <a href="#"><img src="http://rvtext.com/edhik/images/logo.png" width={92} border={0} /></a>
                  </td>
                </tr>
                </tbody></table>
            </div>{/*logo*/}
                  ...
                  <table width={40} height={36} cellPadding={0} cellSpacing={0}>
                    <tbody><tr>
                      <td valign="middle" align="center">
                        <img src="http://rvtext.com/edhik/css/images/srch.png" width={16} style={{ marginTop: 5, cursor: 'pointer' }} />
                      </td>
                    </tr>
                    </tbody></table>
                </div>{/*sub*/}
            ...
            <div className="misc">
              <table height={56} style={{ width: 'auto', borderRight: 'none' }} cellPadding={0} cellSpacing={0} border={0}>
                <tbody><tr>
                  <td valign="middle">
                    <a href="cart-item.html"><img src="http://rvtext.com/edhik/images/ic3.png" width={23} className="m" /></a>
                  </td>
                  <td>
                    <a href="" />
                  </td>
              ...
              <table height={56} style={{ width: 'auto' }} cellPadding={0} cellSpacing={0}>
                <tbody><tr>
                  <td>
                    <img src="http://rvtext.com/edhik/images/ic2.png" width={15} className="mm" />
                  </td>
                  <td>
              ...
              <table height={56} style={{ width: 'auto' }} cellPadding={0} cellSpacing={0}>
                <tbody><tr>
                  <td>
                    <img src="http://rvtext.com/edhik/images/ic1.png" width={10} className="mmm" />
                  </td>
                  <td>
              ...
              megaMenuData.map(item => {
                return (
                  <div className="men">
                    ...
                    <img src="http://rvtext.com/edhik/images/dar.png" width={8} style={{ marginLeft: 2 }} />
                    <div className="content">
                              ...
                              <div className="sec1">
                                <a href="#">
                                  <div className="sec1head">
                                    ...
                                    <img src="http://rvtext.com/edhik/images/sidear.png" width={8} style={{ marginTop: 15, marginLeft: 7 }} />
                                  </div>
                                </a>
